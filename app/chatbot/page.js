      ...
      <div className="w-full min-h-screen py-8 bg-gray-100 md:min-h-screen/8 lg:min-h-screen/6xl dark:bg-gray-800">
        <div className="container px-4 space-y-8 text-center md:space-y-10 lg:space-y-12">
          <div className="space-y-2">
            <h1 className="text-3xl font-bold tracking-tighter md:text-5xl">챗 봇</h1>
            <iframe
              src="https://www.chatbase.co/chatbot-iframe/uTzourT2htwGAsKHZ6YBE"
              title="Chatbot"
              width="100%"
...
// Add CSS import here if needed

// Script for embedding the chatbot
const embeddedChatbotConfig = {
  chatbotId: "uTzourT2htwGAsKHZ6YBE",
...
export function Script() {
  return (
    <>
      <script dangerouslySetInnerHTML={{ __html: `window.embeddedChatbotConfig = ${JSON.stringify(embeddedChatbotConfig)}` }} />
      <script
