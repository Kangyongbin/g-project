      ...
      <div className="w-full min-h-screen py-8 bg-gray-100 md:min-h-screen/8 lg:min-h-screen/6xl dark:bg-gray-800">
        <div className="container px-4 space-y-8 text-center md:space-y-10 lg:space-y-12">
          <div className="space-y-2">
            <h1 className="text-3xl font-bold tracking-tighter md:text-5xl">URL 입력</h1>
            <p className="mx-auto max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
              분석할 URL을 입력하세요. 진단을 시작하려면 '분석' 버튼을 클릭하세요.
            </p>
          </div>
          <div className="mx-auto flex w-full max-w-sm items-start justify-start space-y-0">
            <Input className="w-full text-sm" placeholder="URL 입력" type="text" />
